...
- **Home** — hero com foto e overlay de rastreamento · o problema da base (3 cards + frase de impacto) · teaser do ORBI (4 passos + painel de dashboard + o que você recebe) · diferenciais/valores (5 cards + bloco "alternativa nacional") · produtos (3 cards) · teaser do sobre · prova social (4 métricas com contador animado + 2 depoimentos + logos de clubes) · CTA final
- **ORBI-Analysis** — página do produto com painel interativo: abas, player com rastreamento, stats, mapa de calor
...
- Menu: ORBI Analysis · Escolinhas · Câmera · Sobre · Contato, com versão mobile
...
- No botão secundário do hero, "Conhecer o ORBI", use um **ícone de radar em traço** (círculos concêntricos com marcações) — não use o logo ali
